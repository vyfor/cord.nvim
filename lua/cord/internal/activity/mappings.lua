...
M.filetype_mappings = {
  ...
  go = { 'language', 'go', 'Go' },
  gomod = { 'language', 'go', 'Go' },
  gosum = { 'language', 'go', 'Go' },
  gowork = { 'language', 'go', 'Go' },
