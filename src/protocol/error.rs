...
impl std::fmt::Display for ProtocolError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ProtocolError::InvalidSyntax(msg) => write!(f, "Invalid syntax: {}", msg),
            ProtocolError::InvalidUtf8 => write!(f, "Invalid utf8"),
            ProtocolError::UnexpectedByte(b) => write!(f, "Unexpected byte: {:#x}", b),
            ProtocolError::UnexpectedChar(c) => write!(f, "Unexpected character: '{}'", c),
